...
The board photograph and the 254-cell overlay are visual references. Current legal actions still use the explicitly labelled development fixture because the physical board data is not yet fully transcribed and signed off.

...
The current unresolved 336-cell shell intentionally renders no physical-board terrain, labels, features, or pieces. When those fields are promoted from reviewed source data, they must use these existing layer slots rather than adding a second coordinate or stacking system.

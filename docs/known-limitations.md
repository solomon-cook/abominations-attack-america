...
- Monster Challenge giant-unit ordering and America-saved victory are implemented in the development ruleset, while physical giant base coordinates and four Military Research effects remain source-gated; the two giant cards and X-Fighters placement/combat lifecycle are implemented in the development ruleset.

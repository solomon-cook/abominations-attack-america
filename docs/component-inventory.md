...
| Giant military units | 2 | Mecha-Monster, Captain Colossal | Record-tile catalogue, numeric data, and the two Research-card placement/lifecycle effects are implemented in the development ruleset; Challenge ordering and full-board base coordinates remain source-gated |

...
const PROVISIONAL_CITY_NAMES: Readonly<Record<string, string>> = {
  ...
  "8/5": "Phoenix",
  "6/13": "Kansas City",
  // The orange Infamy panel occupies 6/11 in the authority photo; the
  // nearby St. Louis label is not safely assigned to that face in this pass.
  "6/15": "St. Louis",
  "6/17": "Cincinnati",
  "6/16": "Indianapolis",
  "6/18": "Cleveland",
...
const PROVISIONAL_BOARD_FEATURES: Readonly<Record<string, readonly BoardFeature[]>> = {
  ...
  "4/22": [{ kind: "city", benefit: { kind: "health-roll", dice: 2 } }, { kind: "military-base", branch: "Navy" }],
  ...
  "5/12": [{ kind: "city", benefit: { kind: "health", amount: 1 } }],
  "5/21": [{ kind: "city", benefit: { kind: "health-roll", dice: 2 } }],
  "5/19": [{ kind: "city", benefit: { kind: "health-roll", dice: 1 } }],
  "2/10": [{ kind: "military-base", branch: "Air Force" }],
  "4/20": [{ kind: "military-base", branch: "Army" }],
  "6/20": [{ kind: "city", benefit: { kind: "health-roll", dice: 2 } }, { kind: "military-base", branch: "Marines" }],
  // The authority photo shows both the yellow Air Force star and blue Navy
  // star inside the same coastal face at 6/21.
  "6/21": [{ kind: "military-base", branch: "Air Force" }, { kind: "military-base", branch: "Navy" }],
  "6/12": [{ kind: "military-base", branch: "Army" }],
  "6/13": [{ kind: "city", benefit: { kind: "health", amount: 1 } }, { kind: "military-base", branch: "Air Force" }],
  ...
  "6/15": [{ kind: "city", benefit: { kind: "health-roll", dice: 1 } }],
  "6/16": [{ kind: "city", benefit: { kind: "health", amount: 1 } }],
  "6/17": [{ kind: "city", benefit: { kind: "health", amount: 1 } }],
  "6/18": [{ kind: "city", benefit: { kind: "health", amount: 1 } }],
  "8/2": [{ kind: "city", benefit: { kind: "health-roll", dice: 3 } }, { kind: "los-angeles" }],
  "9/2": [{ kind: "city", benefit: { kind: "health-roll", dice: 1 } }],
  "8/4": [{ kind: "military-base", branch: "Marines" }],
  "8/20": [{ kind: "military-base", branch: "Marines" }],
  "9/3": [{ kind: "military-base", branch: "Marines" }],
  "9/4": [{ kind: "military-base", branch: "Marines" }],
  "8/8": [{ kind: "city", benefit: { kind: "health", amount: 1 } }],
  "8/11": [{ kind: "city", benefit: { kind: "health-roll", dice: 1 } }],
  "8/12": [{ kind: "city", benefit: { kind: "health-roll", dice: 1 } }],
  ...
  "7/19": [{ kind: "city", benefit: { kind: "health", amount: 1 } }, { kind: "military-base", branch: "Army" }],
  "8/16": [{ kind: "city", benefit: { kind: "health", amount: 1 } }, { kind: "military-base", branch: "Army" }],
  "8/17": [{ kind: "city", benefit: { kind: "health-roll", dice: 1 } }],
  "9/13": [{ kind: "military-base", branch: "Air Force" }],
  ...
  "10/12": [{ kind: "city", benefit: { kind: "health", amount: 1 } }, { kind: "military-base", branch: "Army" }],
  ...
  // The authority photo places a yellow Air Force star below the Infamy
  // panel inside each of these same fitted faces.
  "7/4": [{ kind: "infamy-site" }, { kind: "military-base", branch: "Air Force" }],
  "9/6": [{ kind: "infamy-site" }, { kind: "military-base", branch: "Air Force" }],
  "10/11": [{ kind: "infamy-site" }, { kind: "military-base", branch: "Air Force" }],
  "10/19": [{ kind: "infamy-site" }, { kind: "military-base", branch: "Navy" }],
  "7/3": [{ kind: "military-base", branch: "Marines" }],
  "7/21": [{ kind: "military-base", branch: "Marines" }],
  "9/19": [{ kind: "military-base", branch: "Marines" }],
  ...
  "10/16": [{ kind: "challenge-site" }, { kind: "military-base", branch: "Navy" }],
  "10/17": [{ kind: "military-base", branch: "Air Force" }],

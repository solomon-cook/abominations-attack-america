...
try {
  ...
  if (!result || result.count !== 254 || result.rows !== 13 || !/^1\.1547( \/ 1)?$/.test(result.aspectRatio) || !result.creamFace || !result.visible || result.playableTiles !== 0 || result.unresolvedLabels !== 0) {

...
for (const unit of militaryManifest.units) {
  ...
  if (unit.portrait) {
    if (!unit.portrait.startsWith("/assets/military/portraits/") || !unit.portrait.endsWith(".webp")) throw new Error(`Military asset manifest has an invalid portrait for ${unit.id}`);

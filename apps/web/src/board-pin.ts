import { AUDITED_BOARD, DEVELOPMENT_BOARD, FULL_HONEYCOMB_BOARD, PROVISIONAL_AUTHORITATIVE_BOARD, type BoardDefinition, type GameState } from "@abominations/game-engine";
...
export function boardForGame(game: Pick<GameState, "boardId" | "boardVersion" | "boardContentHash">): BoardDefinition | undefined {
  if (game.boardId === AUDITED_BOARD.id && game.boardVersion === AUDITED_BOARD.version && game.boardContentHash === AUDITED_BOARD.contentHash) return AUDITED_BOARD;

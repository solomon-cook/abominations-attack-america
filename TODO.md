...
- [ ] [P0] Complete the Civ VI-style information-dense board experience so the player remains in the full-screen game view while detail appears contextually rather than through a separate “show controls” mode.
  ...
  - [x] Keep the board/map as the dominant, continuously visible gameplay surface; use only lightweight turn-critical overlays by default. (The board-first shell is implemented, but the current header and action dock still expose a controls-panel workflow.)

...
- [ ] [P0] Add end-to-end browser tests for local first playable and two-browser online play.
  - [x] Add a reproducible Chrome CDP smoke harness for local setup, legal movement, path cancellation, path confirmation, and the next authoritative phase (`scripts/verify-browser-local.mjs`, `npm run browser:local:verify`; development-fixture evidence only).

...
- [ ] [P1] Add browser compatibility and responsive visual-regression coverage. (Chrome runtime matrix and deterministic baselines pass; SafariDriver session creation timed out locally, so cross-engine compatibility remains open.)

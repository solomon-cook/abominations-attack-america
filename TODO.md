...
- [ ] [P0] Add end-to-end browser tests for local first playable and two-browser online play.
  ...
  - [x] Verify the read-only full-board review surface renders 254 separated cream faces in 13 staggered rows without playable topology, unresolved labels, or placeholder controls (`npm run browser:board-review:verify`; this remains evidence tooling and does not promote source-gated board data).

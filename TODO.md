...
- [ ] [P1] Build a composable effect system for stat modifiers, movement abilities, attack changes, control overrides, placement, and triggered effects. (Continuous Mutation and Research effects now compose through authoritative projections; optional, triggered, placement, and source-gated lifecycles still need the same explicit effect-boundary treatment.)
  - [x] Compose the independently sourced continuous Mutation and Research stat, movement, deployment, and control effects through authoritative projections; optional, triggered, placement, and source-gated lifecycles remain separate until their rules are verified.

...
- [ ] [P0] Browser verification covers every first-playable decision, cancellation, invalid action, loading state, and victory state.
  - [x] Extend the reproducible local development smoke through the deterministic fixture's authored Denver Fight, source-backed Encounter decision, and Deploy pass; verify unreachable destinations remain disabled; malformed-command, loading, victory, and full-board acceptance remain open.

...
- [ ] [P0] Add end-to-end browser tests for local first playable and two-browser online play.
  ...
  - [x] Add a reproducible two-browser Chrome CDP smoke harness for room create/join, synchronized setup, Ready, Move phase, reload recovery, and one synchronized legal movement (`scripts/verify-browser-online.mjs`, `npm run browser:online:verify`; disconnect/reconnect, victory, and production-board evidence remain open).

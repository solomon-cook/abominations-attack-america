...
- [ ] [P0] Add end-to-end browser tests for local first playable and two-browser online play.
  ...
  - [x] Run a two-tab online setup/reload smoke and record the partial result: synchronized setup and reload recovery pass, while the online move transition remains unverified.

...
- [ ] [P1] Add browser compatibility and responsive visual-regression coverage. (Chrome runtime matrix and deterministic baselines pass; macOS Safari and Ubuntu Firefox CI jobs now create sessions and pass the 254-cell/two-reference board-review smoke, while Edge coverage and manual cross-engine acceptance remain open.)

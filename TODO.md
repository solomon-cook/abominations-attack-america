...
- [ ] [P1] Resolve immediate cards before continuing the interrupted attack, encounter, or deployment sequence. (Defense Satellites now resolves immediately with deterministic rolls and discard; the remaining immediate/conditional Research windows remain source-gated.)

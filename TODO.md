...
- [ ] [P1] Add browser compatibility and responsive visual-regression coverage. (Chrome runtime matrix and deterministic baselines pass; macOS Safari, Ubuntu Firefox, and Ubuntu Edge CI jobs now exercise the browser surface, while manual cross-engine acceptance remains open.)

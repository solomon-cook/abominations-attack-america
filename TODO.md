...
- [ ] [P1] Build a composable effect system for stat modifiers, movement abilities, attack changes, control overrides, placement, and triggered effects. (A shared accumulator now composes the implemented continuous Mutation and Research effects; optional, triggered, placement, and source-gated lifecycles still need the same explicit effect-boundary treatment.)

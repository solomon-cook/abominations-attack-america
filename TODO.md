...
- [ ] [P0] Browser verification covers every first-playable decision, cancellation, invalid action, loading state, and victory state.
  - [x] Extend the reproducible local development smoke through the source-backed Encounter decision and Deploy pass when the deterministic fixture reaches them; Fight, invalid-action, loading, victory, and full-board acceptance remain open.
